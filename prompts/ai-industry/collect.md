...
抓取结果应尽量贴合 `report-outline.md` 的章节需求，确保后续成稿可以直接映射到摘要、核心动态、趋势判断、机会与风险、建议动作、信息缺口和邮件发送摘要。
...
6. 重点关注 AI 头部企业与 AI 领袖人物。
7. 先抓“新变化”，再抓“背景说明”。
8. 每条结果都要明确说明它属于“已确认事实”还是“待确认线索”。
9. 每组结果优先保留 3-5 条最重要信息，不要堆砌低价值线索。
10. `groups` 输出顺序固定为：`AI Agent`、`AI Coding`、`头部 AI 企业`、`AI 领袖人物`、`模型与基础设施`、`开源生态`、`政策与监管`、`待确认线索`。
...
- `头部 AI 企业`：OpenAI、Anthropic、Google DeepMind、Meta、Microsoft、Amazon、NVIDIA 等
- `AI 领袖人物`：创始人、CEO、首席科学家、关键产品负责人
...
- 结果分组优先覆盖 `AI Agent`、`AI Coding`、头部 AI 企业、AI 领袖人物，并尽量对应 `report-outline.md` 的核心章节
