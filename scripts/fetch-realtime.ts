...
// 搜索配置
const SEARCH_TASKS = [
  { id: 1, query: "OpenAI news April 2026", priority: "P0", category: "模型与基础设施", company: "OpenAI" },
  { id: 2, query: "Anthropic Claude update April 2026", priority: "P0", category: "模型与基础设施", company: "Anthropic" },
  ...
  { id: 5, query: "xAI Grok update April 2026", priority: "P1", category: "模型与基础设施", company: "xAI" },
  { id: 6, query: "Sam Altman OpenAI statement April 2026", priority: "P1", category: "模型与基础设施", company: "OpenAI" },
  { id: 7, query: "Meta AI update April 2026", priority: "P1", category: "模型与基础设施", company: "Meta" },
...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  "模型与基础设施": ["model", "gpt", "claude", "gemini", "benchmark", "inference", "llm", "openai", "anthropic", "google", "meta", "microsoft", "xai", "cohere", "mistral", "perplexity", "cursor", "funding", "acquisition", "valuation", "sam altman", "dario amodei", "sundar pichai", "interview", "ceo", "chief", "open source", "github", "huggingface", "llama", "mistral"],
